...
namespace TinyBytes.Idle.UI.Profiling
{
    public class FPSDisplayer : MonoBehaviour
    {
		...
		[SerializeField] private TextMeshProUGUI _displayerText;
		...
		public int MinFpsValueGood = 30;
		public int MinFpsValueWarning = 20;
		...
		protected virtual void Update()
		{
			...
			if (_timeLeft <= 0.0)
			{
				...
				if (_currentFPS >= 0 && _currentFPS <= 300)
				{
					...
					{
						case Modes.Instant:
							_displayerText.text = _stringsFrom00To300[_currentFPS];
							_displayerText.color = GetFPSColor(_currentFPS);
							break;
						case Modes.MovingAverage:
							_displayerText.text = _stringsFrom00To300[_average];
							_displayerText.color = GetFPSColor(_average);
							break;
						case Modes.InstantAndMovingAverage:
							_displayerText.text = _stringsFrom00To300[_currentFPS] + " / " + _stringsFrom00To300[_average];
							_displayerText.color = GetFPSColor(_currentFPS);
							break;
					}
				}
